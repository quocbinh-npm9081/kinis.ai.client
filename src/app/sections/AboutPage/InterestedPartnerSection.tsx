...
const InterestedPartnerSection = () => {
  return (
    <section className='relative flex flex-row items-center justify-center h-auto w-screen'>
      <div className='relative h-full w-2/3'>
        <Image src="/images/interestPartner.png" fill alt='interestPartner' sizes=''/>
      </div>
          ...
          <div className="w-full ">
            <form className="bg-black shadow-md rounded px-8 pt-6 pb-8 mb-4">
              <div className="mb-4">
                ...
                <input className="bg-black shadow appearance-none border rounded w-full py-2 px-3 text-white leading-tight focus:outline-none focus:shadow-outline" id="username" type="text" placeholder="Your name" />
              ...
              <div className="mb-6">
                ...
                <input className="bg-black shadow appearance-none border rounded w-full py-2 px-3 text-white leading-tight focus:outline-none focus:shadow-outline" id="Company" type="text" placeholder="Your company" />
                <p className="text-red-500 text-xs italic">Please choose a password.</p>
              </div>
              <div className="mb-6">
                ...
                <input className="bg-black shadow appearance-none border rounded w-full py-2 px-3 text-white leading-tight focus:outline-none focus:shadow-outline" id="Email" type="text" placeholder="name@yourcompany.com" />
                <p className="text-red-500 text-xs italic">Please choose a password.</p>
              </div>
              ...
              {/* <div className="flex items-center">
                  ...
                  >
                      <svg fill="none" aria-hidden="true" className="h-4 w-4 me-2" viewBox="0 0 20 15">
                          ...
                          <mask id="a" style={{maskType: "luminance"}} width="20" height="15" x="0" y="0" maskUnits="userSpaceOnUse"><rect width="19.6" height="14" y=".5" fill="#fff" rx="2" /></mask>
                          <g mask="url(#a)">
                              <path
                                  fill="#D02F44"
                                  fillRule="evenodd"
                                  ...
                                  <span className="inline-flex items-center">
                                      <svg className="w-4 h-4 me-2" fill="none" viewBox="0 0 20 15">
                                          ...
                                          <g mask="url(#a)">
                                              ...
                                              <g filter="url(#filter0_d_374_135180)"><path fill="#F01515" fillRule="evenodd" d="M0 9.833h19.6V5.167H0v4.666z" clipRule="evenodd" /></g>
                                              <g filter="url(#filter1_d_374_135180)"><path fill="#FFD521" fillRule="evenodd" d="M0 14.5h19.6V9.833H0V14.5z" clipRule="evenodd" /></g>
                                          </g>
                                          <defs>
