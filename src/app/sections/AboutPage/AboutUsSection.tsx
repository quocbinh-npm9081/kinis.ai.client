...
const AboutUsSection = () => {
    return (
        <section className='relative flex min-h-screen w-screen overflow-hidden'> 
          ...
          {/* HERO SECTION */}
          <div className="flex flex-col w-full h-screen items-center justify-between bg-cover bg-center bg-no-repeat pb-14" style={{backgroundImage: `url(/images/AboutUs.png)`}}>
            {/* TOP NAVIGATION */}
            <div className="relative top-0 left-0 w-full " style={{zIndex: 100}}>
