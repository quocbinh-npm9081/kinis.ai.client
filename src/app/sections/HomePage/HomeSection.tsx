...
const HomeSection = () => {
  return (
    <section className='relative flex h-screen w-screen overflow-hidden top-0 z-[999] bg-white'> 
      ...
      {/* HERO SECTION */}
      <div className="flex flex-col w-full h-screen items-center justify-center absolute top-0 left-0 bg-cover bg-center bg-no-repeat" style={{backgroundImage : 'url("/images/banner.png")'}}>
        {/* <Image 
      ...
      <div className="flex flex-col w-full h-screen items-center justify-start absolute top-[7rem] lg:top-[8rem] xl:top-[9rem] 2xl:top-1/4 left-0">
        <div className='mx-auto overflow-hidden w-full top-0 flex flex-row items-start'>
          <div className='overflow-hidden h-full pt-[100px] pl-[15px] md:pl-[25px] 2xl:pl-[50px] absolute left-0 flex flex-col items-center gap-4'>
