// to use gasp with locomotive scroll , we have to use scroller proxy privided by gasp
...
const ScrollTriggerProxy = () => {
    ...
    //register scoll trigger plugin
    gsap.registerPlugin(ScrollTrigger)

    //first let's we  get instance of locamotive 
